...
const SelectItem = React.forwardRef((props, ref) => {
  ...
  return (
    <SelectPrimitive.Item
      ref={ref}
      className={cn(
        "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none data-[disabled]:opacity-50 focus:bg-accent",
        className
      )}
      {...rest}
    >
